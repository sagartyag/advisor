...
@include('layouts.mainsite.header')    
            ...
            <section class="subpage-header">
				<div class="container">
					...
					<a href="{{route('about-us')}}" class="btn btn-primary get-in-touch" data-text="Contact us"><i class="icon-telephone114"></i>Contact us</a>
				</div>
			</section>
					...
					<div class="row">
						...
						<div class="col-md-6 animate fadeInRight">
							<div class="image-widget">
								<img src="{{asset('')}}main/assets/images/about-img1.jpg" class="img-shadow" alt="">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					...
					<div class="two-items-carousel owl-carousel">
						...
						<div class="partner animate fadeInRight">
							<img src="{{asset('')}}main/assets/images/partners/2.jpg" alt="">
							<div class="partner-content">
