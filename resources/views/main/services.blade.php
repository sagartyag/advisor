@include('layouts.mainsite.header')
            ...
            <section class="subpage-header">
				<div class="container">
					...
					<a href="{{route('services')}}" class="btn btn-primary get-in-touch" data-text="Contact us"><i class="icon-telephone114"></i>Contact us</a>
				</div>
			</section>
					...
					<div class="row">
						...
						<div class="col-md-8 animate fadeInRight">
							<div class="single-item-carousel classic-arrows2 owl-carousel">
								<img src="{{asset('')}}main/assets/images/services-img1.jpg" alt="">
								<img src="{{asset('')}}main/assets/images/services-img1.jpg" alt="">
								<img src="{{asset('')}}main/assets/images/services-img1.jpg" alt="">
							</div>
							<br>
							...
							<div class="row">
								...
								<div class="col-md-4"><img src="{{asset('')}}main/assets/images/services-img.jpg" alt=""></div>
							</div>
							<div class="height-50"></div>
