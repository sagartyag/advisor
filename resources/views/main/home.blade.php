            ...
            <header id="header" class="header-two h-two-h" style="display:none;">
				...
				<div class="container">
					...
					<div class="header clearfix">
						...
						<a href="index.html" class="logo"><img src="{{asset('')}}main/assets/images/logo.png" alt=""></a>
						...
						<ul class="header-contact-widget clearfix">
							<li>
								...
								<p>+1 900 234 567<a href="mailto:support@Hml Ad Marketing.com">support@Hml Ad Marketing.com</a></p>
							</li>
							<li>
								<i class="icon-icons74"></i>
								<p>Manhattan Hall,<span>Hml Ad Marketing Melbourne, australia</span></p>
							</li>
							<li>
					...
					<li>
						<div class="cd-full-width">
							<div class="container text-right">
								...
								<a href="{{route('Index')}}" class="btn btn-primary" data-text="view our all services">view our all services</a>
							</div>
						</div>
					</li>
					...
					<div class="row">
						...
						<div class="col-md-6 animate fadeInRight">
							<div class="video-widget">
								<img src="{{asset('')}}main/assets/images/video-thumb.jpg" class="img-shadow" alt="">
					...
					<div class="row">
						<div class="col-md-6 animate fadeInLeft">
							<ul class="image-list-classic ">
								<li><img src="{{asset('')}}main/assets/images/who-is-behind-img1.jpg" alt=""></li>
								<li><img src="{{asset('')}}main/assets/images/who-is-behind-img2.jpg" alt=""></li>
							</ul>
						</div>
						<div class="col-md-6 animate fadeInRight">
            ...
            <section class="meet-our-advisors">
				<div class="container">
					...
					<div class="single-item-carousel owl-carousel classic-arrows">
						...
						<div class="row">
							<div class="col-md-5"><img src="{{asset('')}}main/assets/images/meet-our-advisors-img2.jpg" alt=""></div>
							<div class="col-md-7">
								<div class="meet-advisors-content">
						...
						<div class="row">
							<div class="col-md-5"><img src="{{asset('')}}main/assets/images/meet-our-advisors-img3.jpg" alt=""></div>
							<div class="col-md-7">
								<div class="meet-advisors-content">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="testimonials-author">
											<img class="img-circle" src="{{asset('')}}main/assets/images/review-author-img.png" alt="">
