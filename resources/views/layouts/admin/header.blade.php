                ...
                <li><a href="{{route('admin.add-price')}}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('admin.roi-bonus')}}">Royalty Income</a></li>
                            <li><a href="{{route('admin.reward-bonus')}}">Rewards Income</a></li>                            
                            <li><a href="{{route('admin.activities-bonus')}}">Retire Royalty Income</a></li>
