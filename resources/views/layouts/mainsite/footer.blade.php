<footer id="footer">
		...
		<!-- FOOTER SCRIPTS
		================================================== -->
		<script src="{{asset('')}}main/assets/js/jquery-2.2.0.js"></script>
		<script src="{{asset('')}}main/assets/js/smooth-scroll.js"></script>
		<script src="{{asset('')}}main/assets/js/bootstrap.min.js"></script>
		<script src="{{asset('')}}main/assets/js/counter.js"></script>
		<script src="{{asset('')}}main/assets/js/canvasjs.min.js"></script>
		<script src="{{asset('')}}main/assets/js/common.js"></script>
