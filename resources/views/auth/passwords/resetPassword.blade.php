                ...
                <div class="col-12 col-md-6 col-lg-5 col-xxl-5 offset-xxl-1 text-center ms-xl-auto">
                    <div class="sign__content ms-md-5 ms-xxl-0 pt-120 pb-120">
                        <div class="head_part">
                            ...
                            <h5 class="mt-5 mt-lg-6">Reset Password</h5>
                        </div>
                        <form method="POST" action="{{route('submitResetPassword')}}" autocomplete="off" id="frmContactus" class="contact__form mt-8 mt-lg-10  text-start">
                        {{ csrf_field() }}
                            <div class="d-flex flex-column gap-5 gap-lg-6 ">
                                ...
                                <div class="single-input">
                                    <label class="mb-2 nw1-color" for="cpassword">New Password</label>
                                    <div class="input-pass">
                                        <input type="text" class="fs-six-up bg_transparent pe-13" name="password" id="cpassword" placeholder="Password" required>
                                   
                                    </div>
                                </div>
                                <div class="single-input">
                                    <label class="mb-2 nw1-color" for="cpassword">Confirm New Password</label>
                                    <div class="input-pass">
                                        <input type="text" class="fs-six-up bg_transparent pe-13" name="password_confirmation" id="cpassword" placeholder="Confirm New Password" required>
